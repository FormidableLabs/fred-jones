...
function runReports(files, commonBasePath, flags, reports, options, done) {
...
exports.inspect = function(files, outputDir, options, done) {
  ...
  files = _.map(files, function(file) { return glob.sync(file); });
  ...
  if (!fileOutputDir) {
    runReports(files, commonBasePath, flags, reports, options, function() {
      done(reports);
    });
  } else {
    runReports(files, commonBasePath, flags, reports, options, function() {
