...
var OverviewHistory = require('./models/OverviewHistory');
...
var reporters = {
  complexity : require('./reporters/complexity.js'),
  jshint : require('./reporters/jshint.js')
};
    ...
    _.each(files, function(file) {
      ...
      var report = {
        info : {
          ...
          fileShort : fileShort,
          fileSafe : fileSafe,
          link : 'files/' + fileSafe + '/index.html'
        }
      };
...
exports.inspect = function(files, options, done) {
  ...
  var fileOutputDir = options.outputDir ? path.join(options.outputDir) : false;
